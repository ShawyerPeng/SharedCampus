...
CREATE TABLE `user` (
    `user_id` INT(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,  # 用户ID，主键
    ...
    `alipay` VARCHAR(11) DEFAULT '',                        # 支付宝账号
    ...
    `last_login` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,  # 账号最近登录时间
    `honesty` INT(3) NOT NULL DEFAULT 100,                  # 诚信值
...
CREATE TABLE `task` (
    `task_id` INT(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,   # 任务ID，主键
    `publisher_id` INT(10) NOT NULL,                                # 任务发布者
    ...
    `starttime` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',   # 任务起始时间
    `endtime` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',     # 任务终止时间
...
CREATE TABLE `order` (
    `order_id` INT(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,   # 任务订单ID，主键
    `tid` INT(10) DEFAULT NULL,                 # 任务ID
    `reciever_id` INT(10) DEFAULT NULL,         # 任务接受者ID
    `price` DOUBLE DEFAULT NULL,                # 订单金额
    `task_status` SMALLINT(1) DEFAULT NULL,     # 任务订单状态（订单生成、进行中、已完成、已取消、有纠纷）
    ...
    `rate1` SMALLINT(1) DEFAULT 5,              # 买家评分（任务发布者）
    `rate2` SMALLINT(1) DEFAULT 5,              # 卖家评分（任务接受者）
...
CREATE TABLE `comment` (
    `comment_id` int(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
    `tid` INT(10) NOT NULL,                                         # 任务ID
    `from_uid` INT(10) NOT NULL,                                    # 留言人
    `to_uid` INT(10) DEFAULT NULL,                                  # 回复谁的留言（无回复则NULL）
...
CREATE TABLE `message` (
    `message_id` int(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sysmessage` (
    `sysmessage_id` int(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
    `receiver_id` int(11) NOT NULL,
    `content` VARCHAR(255) NOT NULL,
...
CREATE TABLE `taskmessage` (
    `taskmessage_id` int(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
    `receiver_id` int(11) NOT NULL,
    `content` VARCHAR(255) NOT NULL,
...
CREATE TABLE `image` (
    `image_id` INT(10) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,     # 图片ID，主键
    `filename` VARCHAR(255) NOT NULL DEFAULT '',                # 图片名
    `url` VARCHAR(255) NOT NULL DEFAULT '',                     # 图片存储相对地址
