...
CREATE TABLE `task` (
    ...
    `publisher_id` INT(11) NOT NULL,                                # 任务发布者
    ...
    `starttime` TIMESTAMP NOT NULL DEFAULT NULL,                    # 任务起始时间
...
CREATE TABLE `order` (
    ...
    `tid` INT(11) DEFAULT NULL,                 # 任务ID
    `receiver_id` INT(11) DEFAULT NULL,         # 任务接受者ID
